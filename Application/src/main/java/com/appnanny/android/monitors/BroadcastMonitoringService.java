...
public class BroadcastMonitoringService extends Service {
    ...
    //public BroadcastMonitoringService() {super("BroadcastMonitoringService");}

    private static final String TAG = "BroadcastMonService";
    ...
    public class LocalBinder extends Binder {
        BroadcastMonitoringService getService() {
    ...
    public void onCreate() {
        Log.i(TAG, String.format("[BroadcastMonServ]- Create"));
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i(TAG, String.format("[BroadcastMonServ]- Start"));
        //Log.i("BroadcastMonitoringService received start id " + startId + ": " + intent);
        ...
        receiver = new BroadcastMonitoringService.InstallReceiver();
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        Log.i(TAG, String.format("[BroadcastMonServ]- End"));
    }
    ...
    public class InstallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, String.format("[BroadcastMonServ]- Received User Change - Start"));
            ...
            if (ACTION_USER_SWITCHED.equals(intent.getAction())) {
                ...
                String title = "Broadcast - Monitoring On";
            ...
            Log.i(TAG, String.format("[BroadcastMonServ]- Received User Change - End"));
        }
    }
