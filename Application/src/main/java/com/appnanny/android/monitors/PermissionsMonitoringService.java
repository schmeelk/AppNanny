...
public class PermissionsMonitoringService extends Service {

    //public PermissionsMonitoringService() {super("PermissionsMonitoringService");}

    private static final String TAG = "PermissionsMonService";
    ...
    public class LocalBinder extends Binder {
        PermissionsMonitoringService getService() {
            return PermissionsMonitoringService.this;
        }
    }
    ...
    public void onCreate() {
        Log.i(TAG, String.format("[PermissionsMonServ]- Create"));
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i(TAG, String.format("[PermissionsMonServ]- Start"));
        //Log.i("PermissionsMonitoringService received start id " + startId + ": " + intent);
        ...
        receiver = new PermissionsMonitoringService.InstallReceiver();
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        Log.i(TAG, String.format("[PermissionsMonServ]- End"));
    }
    ...
    public class InstallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, String.format("[PermissionsMonServ]- Received User Change - Start"));
            ...
            if (ACTION_USER_SWITCHED.equals(intent.getAction())) {
                ...
                String title = "Permissions - Monitoring On";
            ...
            Log.i(TAG, String.format("[PermissionsMonServ]- Received User Change - End"));
        }
    }
