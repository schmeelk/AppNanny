...
public class ActivitiesMonitoringService extends Service {

    //public ActivitiesMonitoringService() {super("ActivitiesMonitoringService");}

    private static final String TAG = "ActivitiesMonService";
    ...
    public class LocalBinder extends Binder {
        ActivitiesMonitoringService getService() {
            return ActivitiesMonitoringService.this;
        }
    }
    ...
    public void onCreate() {
        Log.i(TAG, String.format("[ActivitiesMonServ]- Create"));
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i(TAG, String.format("[ActivitiesMonServ]- Start"));
        //Log.i("ActivitiesMonitoringService received start id " + startId + ": " + intent);
        ...
        receiver = new ActivitiesMonitoringService.InstallReceiver();
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        Log.i(TAG, String.format("[ActivitiesMonServ]- End"));
    }
    ...
    public class InstallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, String.format("[ActivitiesMonServ]- Received User Change - Start"));
            ...
            if (ACTION_USER_SWITCHED.equals(intent.getAction())) {
                ...
                String title = "Activities - Monitoring On";
            ...
            Log.i(TAG, String.format("[ActivitiesMonServ]- Received User Change - End"));
        }
    }
