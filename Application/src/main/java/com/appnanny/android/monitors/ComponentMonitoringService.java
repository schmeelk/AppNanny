...
public class ComponentMonitoringService extends Service {

    //public ComponentMonitoringService() {super("ComponentMonitoringService");}

    private static final String TAG = "ComponentMonService";
    ...
    public class LocalBinder extends Binder {
        ComponentMonitoringService getService() {
            return ComponentMonitoringService.this;
        }
    }
    ...
    public void onCreate() {
        Log.i(TAG, String.format("[ComponentMonServ]- Create"));
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i(TAG, String.format("[ComponentMonServ]- Start"));
        //Log.i("ComponentMonitoringService received start id " + startId + ": " + intent);
        ...
        receiver = new ComponentMonitoringService.InstallReceiver();
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        Log.i(TAG, String.format("[ComponentMonServ]- End"));
    }
    ...
    public class InstallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, String.format("[ComponentMonServ]- Received User Change - Start"));
            ...
            if (ACTION_USER_SWITCHED.equals(intent.getAction())) {
                ...
                String title = "Component - Monitoring On";
            ...
            Log.i(TAG, String.format("[ComponentMonServ]- Received User Change - End"));
        }
    }
