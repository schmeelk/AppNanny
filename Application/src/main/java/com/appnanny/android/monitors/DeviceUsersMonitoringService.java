...
public class DeviceUsersMonitoringService extends Service {

    //public DeviceUsersMonitoringService() {super("DeviceUsersMonitoringService");}

    private static final String TAG = "DeviceUsersMonService";
    ...
    public class LocalBinder extends Binder {
        DeviceUsersMonitoringService getService() {
            return DeviceUsersMonitoringService.this;
        }
    }
    ...
    public void onCreate() {
        Log.i(TAG, String.format("[DeviceUsersMonServ]- Create"));
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i(TAG, String.format("[DeviceUsersMonServ]- Start"));
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        Log.i(TAG, String.format("[DeviceUsersMonServ]- End"));
    }
    ...
    public class NetworkReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, String.format("[DeviceUsersMonServ]- Received User Change - Start"));
            ...
            if (ACTION_USER_SWITCHED.equals(intent.getAction())) {
                ...
                String title = "DeviceUsers - Monitoring On";
            ...
            Log.i(TAG, String.format("[DeviceUsersMonServ]- Received User Change - End"));
        }
    }
